...
parser.add_argument('--nlabels', type=int, help='number of semnatic labels (regions in differnet colors) in style_mask/target_mask')
...
def kmeans(xs, k):
    ...
    try:
        ...
        _, labels = kmeans(xs, k, missing='raise')
    return labels
