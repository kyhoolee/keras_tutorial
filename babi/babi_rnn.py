'''
Train 2 rnn based on story and question
the resulting merged vector is then queries to answer a range of bAbI tasks
...
vocab = sorted(reduce(
	lambda x,y : x | y, (set(story + q + [answer])
						 for story, q, answer in train + test)
))

# Reverse 0 for masking via pad_sequences
